        ...
        <div class="container-fluid">
            ...
            <div class="row pt-3">
                @foreach($categories as $category)
                    <div class="col-sm-12 col-md-6 col-lg-4 p-1 gallery-photo">
                ...
                <div class="row about-me__container">
                    <div class="col">
                        <p class="lead text-light">
                            You are warmly welcome on my photo webpage! I hope you will enjoy beautiful landscapes and
                            creative multi-exposures as I
                            firmly believe we have to share our expertise from beautiful places until magic blink
                            snapshots
