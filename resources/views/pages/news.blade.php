...
@section('content')
  ...
  <section>
    <div class="container">
      ...
      <div class="row">
        <div class="col">
          <p class="lead main-text">The photo “Wild” has been selected by juror, Susan Burnstine. It will be included in the exhibition “All About the Light” at
          ...
          <p class="lead main-text">To visit full project “Spring” please visit <a href="https://yvettaphoto.com/portfolio/spring">portfolio</a>.</p>
